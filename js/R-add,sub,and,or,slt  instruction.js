...
function RBind(){
    ...
    $("#ALUOp").bind("animationiteration webkitAnimationIteration oAnimationIteration MSAnimationIteration", function () {
        $('#ALUOp').css("animation-play-state", "paused");
    ...
    $("#data19").bind("animationiteration webkitAnimationIteration oAnimationIteration MSAnimationIteration", function () {
        $('#data19').css("animation-play-state", "paused");
    ...
    $("#data18").bind("animationiteration webkitAnimationIteration oAnimationIteration MSAnimationIteration", function () {
        $('#data18').css("animation-play-state", "paused");
...
function addStep2(){
    ...
    $('#data19').css({"animation":"pathing19 " + 9.5/parseFloat(speed) + "s infinite","animation-play-state":"running"});
    $('#ALUOp').css({"animation":"ALUOp" + 8/parseFloat(speed) + "s infinite","animation-play-state":"running"});
...
function addStep4(){
    ...
    $('#data18').css({"animation":"pathing18 " + 5/parseFloat(speed) + "s infinite","animation-play-state":"running"});
}
