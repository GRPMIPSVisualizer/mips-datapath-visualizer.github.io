...
function beqStep4(){
    ...
    $('#data26_0').css({"animation":"pathing26_0 " + 8/parseFloat(speed) + "s 1","animation-play-state":"running"});
    $('#data26').css({"animation":"pathing26 " + 8/parseFloat(speed) + "s 1","animation-play-state":"running"});
    $('#data27_0').css({"animation":"pathing27_0 " + 20/parseFloat(speed) + "s 1","animation-play-state":"running"});
    $('#data27').css({"animation":"pathing27 " + 20/parseFloat(speed) + "s 1","animation-play-state":"running"});
    stepNum = 4;
    $('#pause').css("pointer-events", "auto");
    $('#pause').css("color", "blue");
}
